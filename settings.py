...
urlgenhelper.timeConfigure('CWA_Radar'                      , "minute", maxHr*60, 30, False)
urlgenhelper.timeConfigure('CWA_Satellite_Visible_EastAsia' , "minute", maxHr*60, 30, False)
urlgenhelper.timeConfigure('CWA_Satellite_Visible_TW'       , "minute", maxHr*60, 30, False)
urlgenhelper.timeConfigure('CWA_Satellite_Infrared_EastAsia', "minute", maxHr*60, 30, False)
urlgenhelper.timeConfigure('CWA_Satellite_Infrared_TW'      , "minute", maxHr*60, 30, False)
